...
<body>
	...
	<div class="panel panel-default">
		...
		<form action="creeActionRessources" method="post" class="form-horizontal">
			<fieldset>
				<legend><spring:message code="form.legend.ressources" /></legend>
				<div class="form-group">
					<label for="formLibelle"><spring:message
					code="form.lbl.ressources" /></label>
					<div class="col-lg-10">
						<input type="text"
				id="formLibelle" name="formLibelle" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-lg-10 col-lg-offset-2">
						<!-- <button class="btn btn-default">Cancel</button><!---->
						<button type="submit" class="btn btn-primary"><spring:message code="form.submit"/></button>
					</div>
				</div>
			</fieldset>
		</form>
