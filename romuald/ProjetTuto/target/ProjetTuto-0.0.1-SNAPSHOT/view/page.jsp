                ...
                <tr>
                    <td valign="top">
                        <table>
                            <tbody>
                                <tr><td>
                                    <c:url value="/afficherListeJoueurs" var="url" />
                                    <a href="${url}">
                                        <spring:message code="titre.listejoueurs"/>
                                    </a>
                                </td></tr>
                                <tr><td>
                                    <c:url value="/afficherCreationListeJoueurs" var="url" />
                                    <a href="${url}">
                                        <spring:message code="titre.creation.elementjoueurs"/>
                                    </a>
                                </td></tr>
                                <tr><td>
                                    <c:url value="/afficherSuppressionListeJoueurs" var="url" />
                                    <a href="${url}">
                                        <spring:message code="titre.suppression.elementjoueurs"/>
                                    </a>
                                </td></tr>
                                <tr><td>
                                    <c:url value="/afficherModificationListeJoueurs" var="url" />
                                    <a href="${url}">
                                        <spring:message code="titre.modification.elementjoueurs"/>
                                    </a>
                                </td></tr>
                            </tbody>
                        </table>
