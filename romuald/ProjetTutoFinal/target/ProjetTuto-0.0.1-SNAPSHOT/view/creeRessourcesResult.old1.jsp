...
<!-- On charge toujour notre css pour surcharger les prÃ©cÃ©dent -->
<link rel="stylesheet" media="all" type="text/css"
	href="<c:url value="/resources/css/template.2.css" />" />
<!-- -->
<!-- Le chargement du javascript peut bloquer la page ,Ã  besin de jquery pour fonctionner-->
<!--  -->
...
<body>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<p>La ressource à biens étée Crée</p>
		</div>
	</div>
		<div class="panel panel-default">
