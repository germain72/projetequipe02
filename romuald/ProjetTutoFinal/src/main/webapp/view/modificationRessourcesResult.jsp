...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<p>La ressource ${RessourceModifier.libebelle } à biens étée modifier
		</p>
		<p>${RessourceModifier.id } | ${RessourceModifier.libebelle } |
			${RessourceModifier.typeRessource } en <br/>
			${RessourceModifierResult.id } | ${RessourceModifierResult.libebelle } |
			${RessourceModifierResult.typeRessource }</p>
	</div>
</div>
